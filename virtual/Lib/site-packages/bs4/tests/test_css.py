...
"""
    ...
    def test_tag_in_tag_many(self):
        for selector in ('html div', 'html body div', 'body div'):
            self.assert_selects(selector, ['data1', 'Nav_Bar', 'inner', 'footer'])


    def test_limit(self):
        self.assert_selects('html div', ['Nav_Bar'], limit=1)
        self.assert_selects('html body div', ['inner', 'Nav_Bar'], limit=2)
        self.assert_selects('body div', ['data1', 'Nav_Bar', 'inner', 'footer'],
                           limit=10)
    ...
    def test_a_bunch_of_emptys(self):
        for selector in ('div#Nav_Bar del', 'div#Nav_Bar div.oops', 'div div#Nav_Bar'):
    ...
    def test_select_on_element(self):
        ...
        # within the tree.
        inner = self.soup.find("div", id="Nav_Bar")
    ...
    def test_closest(self):
        ...
        closest = inner.css.closest("div[id=Nav_Bar]")
        assert closest == self.soup.find("div", id="Nav_Bar")

    def test_match(self):
        inner = self.soup.find("div", id="inner")
        main = self.soup.find("div", id="Nav_Bar")
        assert inner.css.match("div[id=Nav_Bar]") == False
        assert main.css.match("div[id=Nav_Bar]") == True
